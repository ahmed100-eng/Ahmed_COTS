...
#define PORTB_PIN4_INITIAL_VAL         PULLED_UP
#define PORTB_PIN5_INITIAL_VAL         PULLED_UP
#define PORTB_PIN6_INITIAL_VAL         PULLED_UP
#define PORTB_PIN7_INITIAL_VAL         PULLED_UP
